...
my $path_to_edk_proj = "$dv_root/design/sys/edk_bee3";
...
print "setup_bee3_proj.pl:  Copying MicroBlaze Driver\n";
system "cp -rf $path_to_driver/$driver_dir $path_to_edk_proj/bsp";

print "setup_bee3_proj.pl:  Fixing MicroBlaze Driver\n";
...
print "setup_bee3_proj.pl:  Done Fixing MicroBlaze Driver\n\n";
...
my $path_to_pcores = "design/sys/edk_bee3/pcores";
...
print "setup_bee3_proj.pl:  Copying fsl pcore from EDK installation\n";
...
print "setup_bee3_proj.pl:  Fixing timing constraints on fsl pcore\n";
...
print "setup_bee3_proj.pl:  Done fixing timing constraints on fsl pcore\n\n";

#========================
print "setup_bee3_proj.pl:  Copying common files to BEE3 project dir\n";

my $edk_proj  = "$dv_root/design/sys/edk";
my $bee3_proj = "$dv_root/design/sys/edk_bee3";
...
system "cp -r $edk_proj/TestApp_Memory $bee3_proj";

system "cp -r $edk_proj/ccx-firmware $bee3_proj";
system "cp -r $edk_proj/ccx-firmware-diag $bee3_proj";

system "cp -r $edk_proj/pcores/ccx2mb_v1_00_a $bee3_proj/pcores";
system "cp -r $edk_proj/pcores/iop_fpga_v1_00_a $bee3_proj/pcores";

system "cp -r $edk_proj/scripts $bee3_proj";


print "setup_bee3_proj.pl:  Done copying common files to BEE3 project dir\n\n";
