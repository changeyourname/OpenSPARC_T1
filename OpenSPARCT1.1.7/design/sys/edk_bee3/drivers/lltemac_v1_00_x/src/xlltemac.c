...
void XLlTemac_Reset(XLlTemac *InstancePtr, int HardCoreAction)
{
	 ...
	 * registers. This must be done to allow the MGT clock to become stable for
	 * the Sgmii and 1000BaseX PHY interfaces. No other register reads will be
	 * valid until this bit is valid.
