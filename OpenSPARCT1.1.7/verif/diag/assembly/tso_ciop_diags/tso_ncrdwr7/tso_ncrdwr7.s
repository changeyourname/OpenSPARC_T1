...
* 
* OpenSPARC T1 Processor File: tso_ncrdwr7.s
...
/***************************************************************************
*** 
***  Test Description : trying a cacheable space access with the side-effect bit set.
***
**********************************************************************/
#define JBI_CONFIG
...
SECTION .CEDATA  DATA_VA=0x160000

attr_data {
        Name = .CEDATA,
        VA=0x160000,
        RA=0x100160000,
        PA=ra2pa(0x100160000,0),
        part_0_d_ctx_nonzero_ps0_tsb,
        TTE_G=0, TTE_Context=PCONTEXT, TTE_V=1, TTE_Size=0, TTE_NFO=0,
        TTE_IE=0, TTE_Soft2=0, TTE_Diag=0, TTE_Soft=0,
        TTE_L=0, TTE_CP=1, TTE_CV=1, TTE_E=1, TTE_P=0, TTE_W=1
        }
