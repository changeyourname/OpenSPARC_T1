...
* 
* OpenSPARC T1 Processor File: dram_mt_32th_loads_attrib_many_2ch.s
...
*/
/***********************************************************************
 * Name:   dram_mt_32th_loads_attrib_many_2ch.s
 * Date:    July 24, 2003
 *
 *  Description: more different index read.
 *   2ch mode 
 *   Currently these diags need to use sim_run_args 2CHANNEL_23
 *   since for the 2 channel case the boot code should set the dram 
 *   registers, else if the code for setting the 2 channel comes from
 *   instr fecth, its chicken and egg problem as memory need to 
 *   be initialized as either 2/4 channel.
 *
 **********************************************************************/
...
main:
  ...
  setx    0x1000, %l0, %l5      ! go to next dram channel
  ! Disable Channel 0
  setx  0x0000000000000001, %l0, %l2
  stx   %l2, [%l1+0x138]

  ! Disable Channel 1
  add   %l1, %l5, %l1         ! same index, diff tag
  stx   %l2, [%l1+0x138]
...
loop01:
  ...
  ! Other channel  ( Channel 2) 
  ! These would go to respective channel
  ldx   [%l1+0x80], %l3
  not   %l3                   ! perform negation, to change value
  stx   %l3, [%l1+0x80]            ! cache line is now dirty 

  ldx   [%l1+0x180], %l3
  not   %l3                   ! perform negation, to change value
  stx   %l3, [%l1+0x180]      ! cache line is now dirty
  ldx   [%l1+0x280], %l3
  not   %l3                   ! perform negation, to change value
  stx   %l3, [%l1+0x280]      ! cache line is now dirty
  ldx   [%l1+0x380], %l3
  not   %l3                   ! perform negation, to change value
  stx   %l3, [%l1+0x380]      ! cache line is now dirty

  add   %l1, %l5, %l2         ! same index, diff tag

  ldx   [%l2+0x80], %l3
  not   %l3                   ! perform negation, to change value
  stx   %l3, [%l2+0x80]            ! cache line is now dirty 

  ldx   [%l2+0x180], %l3
  not   %l3                   ! perform negation, to change value
  stx   %l3, [%l2+0x180]      ! cache line is now dirty
  nop
  ldx   [%l2+0x280], %l3
  not   %l3                   ! perform negation, to change value
  stx   %l3, [%l2+0x280]      ! cache line is now dirty
  nop
  ldx   [%l2+0x380], %l3
  not   %l3                   ! perform negation, to change value
  stx   %l3, [%l2+0x380]      ! cache line is now dirty
  nop
  ...
  ldx   [%l1+0x480], %l3
  not   %l3                   ! perform negation, to change value
  stx   %l3, [%l1+0x480]      ! cache line is now dirty
  !add   %l1, %l5, %l2         ! same index, diff tag
  ldx   [%l2+0x480], %l3
  not   %l3                   ! perform negation, to change value
  stx   %l3, [%l2+0x480]      ! cache line is now dirty

  ldx   [%l1+0x580], %l3
  not   %l3                   ! perform negation, to change value
  stx   %l3, [%l1+0x580]      ! cache line is now dirty
  !add   %l1, %l5, %l2         ! same index, diff tag
  ldx   [%l2+0x580], %l3
  not   %l3                   ! perform negation, to change value
  stx   %l3, [%l2+0x580]      ! cache line is now dirty

  ldx   [%l1+0x680], %l3
  not   %l3                   ! perform negation, to change value
  stx   %l3, [%l1+0x680]      ! cache line is now dirty
  !add   %l1, %l5, %l2         ! same index, diff tag
  ldx   [%l2+0x680], %l3
  not   %l3                   ! perform negation, to change value
  stx   %l3, [%l2+0x680]      ! cache line is now dirty

  ldx   [%l1+0x780], %l3
  not   %l3                   ! perform negation, to change value
  stx   %l3, [%l1+0x780]      ! cache line is now dirty
  !add   %l1, %l5, %l2         ! same index, diff tag
  ldx   [%l2+0x780], %l3
  not   %l3                   ! perform negation, to change value
  stx   %l3, [%l2+0x780]      ! cache line is now dirty

  ldx   [%l1+0xc80], %l3
  not   %l3                   ! perform negation, to change value
  stx   %l3, [%l1+0xc80]      ! cache line is now dirty
  !add   %l1, %l5, %l2         ! same index, diff tag
  ldx   [%l2+0xc80], %l3
  not   %l3                   ! perform negation, to change value
  stx   %l3, [%l2+0xc80]      ! cache line is now dirty

  ldx   [%l1+0xd80], %l3
  not   %l3                   ! perform negation, to change value
  stx   %l3, [%l1+0xd80]      ! cache line is now dirty
  !add   %l1, %l5, %l2         ! same index, diff tag
  ldx   [%l2+0xd80], %l3
  not   %l3                   ! perform negation, to change value
  stx   %l3, [%l2+0xd80]      ! cache line is now dirty

  ldx   [%l1+0xe80], %l3
  not   %l3                   ! perform negation, to change value
  stx   %l3, [%l1+0xe80]      ! cache line is now dirty
  !add   %l1, %l5, %l2         ! same index, diff tag
  ldx   [%l2+0xe80], %l3
  not   %l3                   ! perform negation, to change value
  stx   %l3, [%l2+0xe80]      ! cache line is now dirty

  ldx   [%l1+0xf80], %l3
  not   %l3                   ! perform negation, to change value
  stx   %l3, [%l1+0xf80]      ! cache line is now dirty
  !add   %l1, %l5, %l2         ! same index, diff tag
  ldx   [%l2+0xf80], %l3
  not   %l3                   ! perform negation, to change value
  stx   %l3, [%l2+0xf80]      ! cache line is now dirty


  ldx   [%l1+0x880], %l3
  not   %l3                   ! perform negation, to change value
  stx   %l3, [%l1+0x880]      ! cache line is now dirty
  !add   %l1, %l5, %l2         ! same index, diff tag
  ldx   [%l2+0x880], %l3
  not   %l3                   ! perform negation, to change value
  stx   %l3, [%l2+0x880]      ! cache line is now dirty

  ldx   [%l1+0x980], %l3
  not   %l3                   ! perform negation, to change value
  stx   %l3, [%l1+0x980]      ! cache line is now dirty
  !add   %l1, %l5, %l2         ! same index, diff tag
  ldx   [%l2+0x980], %l3
  not   %l3                   ! perform negation, to change value
  stx   %l3, [%l2+0x980]      ! cache line is now dirty

  ldx   [%l1+0xa80], %l3
  not   %l3                   ! perform negation, to change value
  stx   %l3, [%l1+0xa80]      ! cache line is now dirty
  !add   %l1, %l5, %l2         ! same index, diff tag
  ldx   [%l2+0xa80], %l3
  not   %l3                   ! perform negation, to change value
  stx   %l3, [%l2+0xa80]      ! cache line is now dirty

  ldx   [%l1+0xb80], %l3
  not   %l3                   ! perform negation, to change value
  stx   %l3, [%l1+0xb80]      ! cache line is now dirty
  !add   %l1, %l5, %l2         ! same index, diff tag
  ldx   [%l2+0xb80], %l3
  not   %l3                   ! perform negation, to change value
  stx   %l3, [%l2+0xb80]      ! cache line is now dirty
