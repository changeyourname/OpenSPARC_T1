...
* 
* OpenSPARC T1 Processor File: dram_mt_32th_loads_attrib_many_scrb_en_2ch.s
...
main:
  ...
  ! Enable Scrub (scrub should not be enabled for disabled channel)
  ...
  ! Enable Scrub ch1 (scrub should not be enabled for disabled channel)
  !setx  0x0000000000000001, %l0, %l2
  !stx   %l2, [%l1+0x40]
  !! Set Scrub frequency to a low value
  !setx  0x0000000000000005, %l0, %l2
