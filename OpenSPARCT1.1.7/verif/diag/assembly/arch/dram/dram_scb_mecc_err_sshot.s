...
* 
* OpenSPARC T1 Processor File: dram_scb_mecc_err_sshot.s
...
*/
/***********************************************************************
 * Name:    dram_scb_mecc_err_sshot.s
 * Date:    July 24, 2003
 *
 *  Description:
...
loop_reg : 
  ...
  ! cont. error with ecc mask , 0x0f0f, MECC, sshot
  setx  0x00000000c0000f0f, %l0, %l2
  stx   %l2, [%l1+0x290]
  nop
