...
* 
* OpenSPARC T1 Processor File: fp_sqrt0.s
 ...
 *
 *  Description:
 *  	This test is intended test all fp sqrt instructions
 *
 **********************************************************************/
 ...
 *******************************************************/
	...
	setx		fsr_tem_dis, %l0, %l4	! fsr tem enable value
...
/* Simple sqrt */
	...
	fsqrtq		%f0, %f0		! This should cause - unimplemented fpop
	.word		0x85a00560		! Set [1] of rd to 1 - invalid fp
	...
	fsqrtsd_rd_int_loop:			! Rounding mode loop
	...
	fsqrtsd_int_loop:			! Rounding mode loop
	...
	bne,a		fsqrtsd_int_loop	! If not 0, go to test more
        nop

	add		%g7, 0x1, %g7
	subcc		%g7, %g6, %g0

	bne,a		fsqrtsd_rd_int_loop	! If not 0, go to test more
        nop
...
/* Common loops for all types of instructions - for normals and denormals */
	...
	fsqrtsd_rd_denorm_loop:			! Rounding mode loop

	sll		%g7, 0x2, %g5		! Align address
	ld		[%l3+%g5], %fsr		! Read it from memory - trap enabled
	...
	bne,a		fsqrtsd_denorm_loop	! If not 0, go to test more
        nop

	add		%g7, 0x1, %g7
	subcc		%g7, %g6, %g0

	bne,a		fsqrtsd_rd_denorm_loop	! If not 0, go to test more
        nop
	...
	fsqrtsd_rd_norm_loop:			! Rounding mode loop
	...
	bne,a		fsqrtsd_norm_loop	! If not 0, go to test more
        nop

	add		%g7, 0x1, %g7
	subcc		%g7, %g6, %g0

	bne,a		fsqrtsd_rd_norm_loop	! If not 0, go to test more
        nop
