...
* 
* OpenSPARC T1 Processor File: fp_fxtox0.s
 ...
 *
 *  Description:
 *  	This test is intended test all fp converstions
 *
 **********************************************************************/
...
main:
	...
	setx		ddata1, %l0, %l7	! Double precision boundaries
...
/*  fp to int  */
	...
	fqtox		%f0, %f0		! This should cause - unimplemented fpop
	fqtoi		%f0, %f0		! This should cause - unimplemented fpop
	.word		0x85a01060		! Set [1] of rd to 1 - invalid fp
	.word		0x85a01a60		! Set [1] of rd to 1 - invalid fp
...
/*  fp to fp */
	...
	fstoq		%f0, %f0		! This should cause - unimplemented fpop
	fdtoq		%f0, %f0		! This should cause - unimplemented fpop
	fqtos		%f0, %f0		! This should cause - unimplemented fpop
	fqtod		%f0, %f0		! This should cause - unimplemented fpop

	! Untrapped Result in Different format from operands

	! F[sd]to[sd] with quiet NaN
	! 

	setx		sp_n_u_quiet_nan, %l0, %l4	! 
	ld		[%l4+0x0], %f0
	fstod		%f0, %f2

	setx		sp_n_l_quiet_nan, %l0, %l4	! 
	ld		[%l4+0x0], %f0
	fstod		%f0, %f2

	setx		sp_p_u_quiet_nan, %l0, %l4	! 
	ld		[%l4+0x0], %f0
	fstod		%f0, %f2

	setx		sp_p_l_quiet_nan, %l0, %l4	! 
	ld		[%l4+0x0], %f0
	fstod		%f0, %f2

	setx		sp_n_quiet_nan_0, %l0, %l4	! 
	ld		[%l4+0x0], %f0
	fstod		%f0, %f2

	setx		sp_n_quiet_nan_1, %l0, %l4	! 
	ld		[%l4+0x0], %f0
	fstod		%f0, %f2

	setx		sp_p_quiet_nan_0, %l0, %l4	! 
	ld		[%l4+0x0], %f0
	fstod		%f0, %f2

	setx		sp_p_quiet_nan_1, %l0, %l4	! 
	ldd		[%l4+0x0], %f0
	fstod		%f0, %f2

	setx		dp_n_u_quiet_nan, %l0, %l4	! 
	ldd		[%l4+0x0], %f0
	fdtos		%f0, %f2

	setx		dp_n_l_quiet_nan, %l0, %l4	! 
	ldd		[%l4+0x0], %f0
	fdtos		%f0, %f2

	setx		dp_p_u_quiet_nan, %l0, %l4	! 
	ldd		[%l4+0x0], %f0
	fdtos		%f0, %f2

	setx		dp_p_l_quiet_nan, %l0, %l4	! 
	ldd		[%l4+0x0], %f0
	fdtos		%f0, %f2

	setx		dp_n_quiet_nan_0, %l0, %l4	! 
	ldd		[%l4+0x0], %f0
	fdtos		%f0, %f2

	setx		dp_n_quiet_nan_1, %l0, %l4	! 
	ldd		[%l4+0x0], %f0
	fdtos		%f0, %f2

	setx		dp_p_quiet_nan_0, %l0, %l4	! 
	ldd		[%l4+0x0], %f0
	fdtos		%f0, %f2

	setx		dp_p_quiet_nan_1, %l0, %l4	! 
	ldd		[%l4+0x0], %f0
	fdtos		%f0, %f2

	! How about indeterminate (??)

	setx		sp_n_ind_nan, %l0, %l4	! 
	ld		[%l4+0x0], %f0
	fstod		%f0, %f2

	setx		dp_n_ind_nan, %l0, %l4	! 
	ldd		[%l4+0x0], %f0
	fdtos		%f0, %f2

	! F[sd]to[sd] with a signaling NaN
	! This should cause NV exception.

	setx		sp_n_u_signaling_nan, %l0, %l4	! 
	ld		[%l4+0x0], %f0
	fstod		%f0, %f2

	setx		sp_n_l_signaling_nan, %l0, %l4	! 
	ld		[%l4+0x0], %f0
	fstod		%f0, %f2

	setx		sp_p_u_signaling_nan, %l0, %l4	! 
	ld		[%l4+0x0], %f0
	fstod		%f0, %f2

	setx		sp_p_l_signaling_nan, %l0, %l4	! 
	ld		[%l4+0x0], %f0
	fstod		%f0, %f2

	setx		sp_n_signaling_nan_0, %l0, %l4	! 
	ld		[%l4+0x0], %f0
	fstod		%f0, %f2

	setx		sp_p_signaling_nan_0, %l0, %l4	! 
	ld		[%l4+0x0], %f0
	fstod		%f0, %f2

	setx		dp_n_u_signaling_nan, %l0, %l4	! 
	ldd		[%l4+0x0], %f0
	fdtos		%f0, %f2

	setx		dp_n_l_signaling_nan, %l0, %l4	! 
	ldd		[%l4+0x0], %f0
	fdtos		%f0, %f2

	setx		dp_p_u_signaling_nan, %l0, %l4	! 
	ldd		[%l4+0x0], %f0
	fdtos		%f0, %f2

	setx		dp_p_l_signaling_nan, %l0, %l4	! 
	ldd		[%l4+0x0], %f0
	fdtos		%f0, %f2

	setx		dp_n_signaling_nan_0, %l0, %l4	! 
	ldd		[%l4+0x0], %f0
	fdtos		%f0, %f2

	setx		dp_p_signaling_nan_0, %l0, %l4	! 
	ldd		[%l4+0x0], %f0
	fdtos		%f0, %f2

/*  int to fp */

	fxtoq		%f0, %f4		! Unimplemented fpop
	fitoq		%f0, %f4		! Unimplemented fpop

	! Put it in a loop

	setx		int_data_i, %l0, %l4	! Denorm sp
	setx		int_data_x, %l0, %l6	! Denorm dp

	set		0x4, %g6		! Max loop count for rd
	set		0x0, %g7		! loop iterator	

	fixtosd_rd_denorm_loop:			! Rounding mode loop
	...
	fixtosd_denorm_loop:			! Rounding mode loop
	...
	bne,a		fixtosd_denorm_loop	! If not 0, go to test more
        nop

	add		%g7, 0x1, %g7
	subcc		%g7, %g6, %g0

	bne,a		fixtosd_rd_denorm_loop	! If not 0, go to test more
        nop

/* Common loops for all types of instructions - for normals and denormals */

	! Denormals	
	! Put them in a loop

	setx		data1_denorm, %l0, %l4	! Denorm sp
	setx		ddata1_denorm, %l0, %l6	! Denorm dp

	set		0x4, %g6		! Max loop count rd
	set		0x0, %g7		! loop iterator	

	fsdtoix_rd_denorm_loop:			! Rounding mode loop

	sll		%g7, 0x2, %g5		! Align address
	ld		[%l3+%g5], %fsr		! Read it from memory - trap disabled

	set		0xc, %g1		! Max loop count
	set		0x0, %g2		! loop iterator	
	...
	fstox		%f0, %f20		! Conversions
	fstoi		%f0, %f22		! Conversions
	fstod		%f0, %f24
	fdtox		%f2, %f26		! Conversions
	fdtoi		%f2, %f28		! Conversions
	fdtos		%f2, %f30
	fxtos		%f20, %f10
	fxtos		%f26, %f12
	fxtod		%f20, %f14
	...
	bne,a		fsdtoix_denorm_loop	! If not 0, go to test more
        nop

	add		%g7, 0x1, %g7
	subcc		%g7, %g6, %g0

	bne,a		fsdtoix_rd_denorm_loop	! If not 0, go to test more
        nop

	! Normals	
	! Put them in a loop

	setx		data1_norm, %l0, %l4	! Denorm sp
	setx		ddata1_norm, %l0, %l6	! Denorm dp

	set		0x4, %g6		! Max loop count rd
	set		0x0, %g7		! loop iterator	

	fsdtoix_rd_norm_loop:			! Rounding mode loop

	sll		%g7, 0x2, %g5		! Align address
	ld		[%l3+%g5], %fsr		! Read it from memory - trap disabled

	set		0x20, %g1		! Max loop count
	set		0x0, %g2		! loop iterator	
	...
	bne,a		fsdtoix_norm_loop	! If not 0, go to test more
        nop

	add		%g7, 0x1, %g7
	subcc		%g7, %g6, %g0

	bne,a		fsdtoix_rd_norm_loop	! If not 0, go to test more
        nop
