...
* 
* OpenSPARC T1 Processor File: fp_brfccn0.s
 ...
 *
 *  Description:
 *  	This test is intended test fcmp with branches following them.
 *
 **********************************************************************/
 ...
 *******************************************************/
	...
	ld		[%l4+0x0], %f0		! 
	ld		[%l6+0x0], %f4		! 
	fcmps		%fcc0, %f4, %f0		! Should result in negative overflow
	fcmpes		%fcc0, %f4, %f0		! Should result in negative overflow

	! Go thru normals and denormals - only adjacent sub/add
...
tgt4f:
	...
	fba,a,pn	%fcc0, tgt50
	nop
tgt50:	fbn,a,pn	%fcc0, tgt51
	nop
tgt51:	fbu,a,pn	%fcc0, tgt52
	nop
tgt52:	fbg,a,pn	%fcc0, tgt53
	nop
tgt53:	fbug,a,pn	%fcc0, tgt54
	nop
tgt54:	fbl,a,pn	%fcc0, tgt55
	nop
tgt55:	fbul,a,pn	%fcc0, tgt56
	nop
tgt56:	fblg,a,pn	%fcc0, tgt57
	nop
tgt57:	fbne,a,pn	%fcc0, tgt58
	nop
tgt58:	fbe,a,pn	%fcc0, tgt59
	nop
tgt59:	fbue,a,pn	%fcc0, tgt5a
	nop
tgt5a:	fbge,a,pn	%fcc0, tgt5b
	nop
tgt5b:	fbuge,a,pn	%fcc0, tgt5c
	nop
tgt5c:	fble,a,pn	%fcc0, tgt5d
	nop
tgt5d:	fbule,a,pn	%fcc0, tgt5e
	nop
tgt5e:	fbo,a,pn	%fcc0, tgt5f
	nop
tgt5f:
	...
	fba,a,pn	%fcc0, tgt60
	nop
tgt60:	fbn,a,pn	%fcc0, tgt61
	nop
tgt61:	fbu,a,pn	%fcc0, tgt62
	nop
tgt62:	fbg,a,pn	%fcc0, tgt63
	nop
tgt63:	fbug,a,pn	%fcc0, tgt64
	nop
tgt64:	fbl,a,pn	%fcc0, tgt65
	nop
tgt65:	fbul,a,pn	%fcc0, tgt66
	nop
tgt66:	fblg,a,pn	%fcc0, tgt67
	nop
tgt67:	fbne,a,pn	%fcc0, tgt68
	nop
tgt68:	fbe,a,pn	%fcc0, tgt69
	nop
tgt69:	fbue,a,pn	%fcc0, tgt6a
	nop
tgt6a:	fbge,a,pn	%fcc0, tgt6b
	nop
tgt6b:	fbuge,a,pn	%fcc0, tgt6c
	nop
tgt6c:	fble,a,pn	%fcc0, tgt6d
	nop
tgt6d:	fbule,a,pn	%fcc0, tgt6e
	nop
tgt6e:	fbo,a,pn	%fcc0, tgt6f
	nop
tgt6f:
	...
	bne,a		fcmpbr_in_loop1		! If not 0, go to test more
        nop
