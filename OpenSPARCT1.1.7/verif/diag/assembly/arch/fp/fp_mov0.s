...
* 
* OpenSPARC T1 Processor File: fp_mov0.s
 ...
 *
 *  Description:
 *  	This test is intended test unconditional fmov, fba, fneg
 *
 **********************************************************************/
 ...
 *******************************************************/
	...
	setx		data1, %l0, %l2		! Non zero data with different data in f0 and f1
	...
	bne,a		fmov_in_loop1		! If not 0, go to test more
        nop
