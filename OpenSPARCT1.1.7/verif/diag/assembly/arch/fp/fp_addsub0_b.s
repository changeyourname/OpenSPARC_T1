...
* 
* OpenSPARC T1 Processor File: fp_addsub0_b.s
...
/*  Basic fp add and sub */
	...
	faddsub_rd_loop1:			! Rounding mode loop
	...
	bne,a		faddsub_in_loop1	! If not 0, go to test more
        nop

	add		%l7, 0x1, %l7
	subcc		%l7, %g1, %g0

	bne,a		faddsub_out_loop1	! If not 0, go to test more
        nop

	add		%g7, 0x1, %g7
	subcc		%g7, %g6, %g0

	bne,a		faddsub_rd_loop1	! If not 0, go to test more
        nop
