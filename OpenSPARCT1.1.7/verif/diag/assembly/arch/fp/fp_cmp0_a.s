...
* 
* OpenSPARC T1 Processor File: fp_cmp0_a.s
...
/*  Basic fp cmp */
	...
	fcmp_rd_loop0:				! Rounding mode loop
	...
	bne,a		fcmp_loop0		! If not 0, go to test more
        nop

	add		%g7, 0x1, %g7
	subcc		%g7, %g6, %g0

	bne,a		fcmp_rd_loop0		! If not 0, go to test more
        nop
