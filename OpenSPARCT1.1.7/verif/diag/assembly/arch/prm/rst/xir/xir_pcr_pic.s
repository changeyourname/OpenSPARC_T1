...
* 
* OpenSPARC T1 Processor File: xir_pcr_pic.s
 ...
 * Date:  	Nov, 2003 
 *
 * Description: After POR writes to pcr and Pic and causes XIR;
		after XIR check pcr and pic
 *
 **********************************************************************/
...
#define  My_External_Reset rd      %asr17, %g4; \
			   setx    pcr,  %o5, %o6; \
                           jmpl    %o6, %g0; nop
