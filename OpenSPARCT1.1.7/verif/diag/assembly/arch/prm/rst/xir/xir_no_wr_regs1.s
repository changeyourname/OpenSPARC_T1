...
* 
* OpenSPARC T1 Processor File: xir_no_wr_regs1.s
...
*/
/***********************************************************************
 * Name:	xir_no_wr_regs1.s   
 * Date:  	Nov, 2003 
 *
 * Description:
 
   After POR causes an XIR; 
   after XIR, the Trap_handler checks conntents of the registers.
...
#define  My_External_Reset rd      %pc, %g1; \
                           rd      %pc, %g2; \
                           setx    rstv,  %g5, %g6; \
                           jmpl    %g6, %g0; nop
