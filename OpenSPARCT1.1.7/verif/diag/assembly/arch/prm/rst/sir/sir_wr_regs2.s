...
* 
* OpenSPARC T1 Processor File: sir_wr_regs2.s
 ...
 * Description:
   ...
   Issue: 1. Confusion about tpc, tnpc
	  2. %tl ; after SIR (as %tl was cleared before reset)
	     commented out
	     Simulation gives 0x1
 **********************************************************************/
...
#define  My_Software_Initiated_Reset rdpr      %tpc, %g1; \
                           rdpr      %tnpc, %g2; \
			   setx    chk,  %o5, %o6; \
                           jmpl    %o6, %g0; nop
