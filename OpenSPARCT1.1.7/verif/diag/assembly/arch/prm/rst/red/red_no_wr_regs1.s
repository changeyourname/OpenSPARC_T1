...
* 
* OpenSPARC T1 Processor File: red_no_wr_regs1.s
...
*/
/***********************************************************************
 * Name:	red_no_wr_regs1.s   
 * Date:  	Nov, 2003 
 *
 * Description:
 
   After POR causes an RED_Reset; 
   ...
   Issue: %tt = ? simulation says 0x100; commented out
	  %tl = ?
 **********************************************************************/
...
#define  My_RED_Mode_Other_Reset rd      %pc, %g1; \
                           rd      %pc, %g2; \
                           setx    rstv,  %g5, %g6; \
                           jmpl    %g6, %g0; nop
