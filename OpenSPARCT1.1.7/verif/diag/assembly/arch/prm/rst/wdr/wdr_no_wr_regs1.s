...
* 
* OpenSPARC T1 Processor File: wdr_no_wr_regs1.s
...
*/
/***********************************************************************
 * Name:	wdr_no_wr_regs1.s   
 * Date:  	Nov, 2003 
 *
 * Description:
 
   After POR causes an WDR; 
   after WDR, the Trap_handler checks contents of the registers.

   Registers which has X's after WDR or had X's after POR and
   not changed after WDR, are not read here.
...
#define  My_Watchdog_Reset rd      %pc, %g1; \
                           rd      %pc, %g2; \
                           setx    rstv,  %g5, %g6; \
                           jmpl    %g6, %g0; nop
