...
* 
* OpenSPARC T1 Processor File: L2_Tag_Array_diag_access_test_4T.s
...
th_main_1:
	add	%g0,0x48,%g6			! bank 1 & ecc 5:3 = 001
	or	%g0,1,%g7
        setx	active_thread, %l1, %o5 
        jmpl    %o5, %o7
        nop
...
th_main_2:
	add	%g0,0x90,%g6			! bank 2 & ecc 5:3 = 010
	or	%g0,2,%g7
        setx	active_thread, %l1, %o5 
        jmpl    %o5, %o7
        nop
...
th_main_3:
	add	%g0,0xe0,%g6			! bank 3 & ecc 5:3 = 100
	or	%g0,3,%g7
        setx	active_thread, %l1, %o5 
        jmpl    %o5, %o7
        nop
...
All_caches_disabled:
	or	%g0,L2_DIAG_TAG_ARRAY_BASE_VA_HI,%g1
	sllx	%g1,L2_VA_HI_SAMT,%g1		! build address 39:32 of L2 TAG Diag access
	add	%g1,%g6,%g1			! set bank and ecc bits

	or	%g0,%g0,%g2			! initialize loop counter
	or	%g0,0x100,%g3			! loop incr value
	setx	0x00100000,%l0,%g4		! stop value

		
Write_loop_top:
	add	%g1,%g2,%l1
	stx	%l1,[%l1+0]			! Store tag
	
	add	%g2,%g3,%g2			! next entry (way || set)	
	cmp	%g2,%g4				
	bl	Write_loop_top			! exit when > 0x00100000
	nop

	
Read_loop_setup:
	or	%g0,%g0,%g2			! initialize loop counter
	setx	0x003fffc0,%l0,%g5		! mask for care about bits
...
Read_loop_top:
	...
	xor	%l1,%i1,%l5
	andcc	%l5,%g5,%l6			! check if care about bits mismatch
	bnz	Test_fail
	nop
	...
	cmp	%g2,%g4				
	bl	Read_loop_top			! exit when > 0x00300000
	nop
