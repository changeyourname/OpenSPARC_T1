...
* 
* OpenSPARC T1 Processor File: pio_dma_basic1.s
...
***                     On top adding PIO access This has a different
***			SJM4,5 then basic ( SJM5 is disbaled since the sync addr
***			is not the same) Only 8 byte PIO st/ld
***
**********************************************************************/
#define JBI_CONFIG
