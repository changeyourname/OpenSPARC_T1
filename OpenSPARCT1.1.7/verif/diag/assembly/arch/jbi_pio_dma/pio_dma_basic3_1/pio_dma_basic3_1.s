...
* 
* OpenSPARC T1 Processor File: pio_dma_basic3_1.s
...
***                     Add Fifo configurations varaiations
***
**********************************************************************/
#define JBI_CONFIG
...
! Set the JBI FIFO config parameters to tight ( lowest values)
!=====================
setx 0x8000000008, %g1, %g3
add   %g0, 0x10, %l7           ! for new address

setx 0x0000000010000e00, %g1, %g2
stx %g2, [%g3]
call      main_pio
nop

setx 0x0000000020011c01, %g1, %g2
stx %g2, [%g3]
call      main_pio
nop

setx 0x0000000030002d02, %g1, %g2
stx %g2, [%g3]
call      main_pio
nop

setx 0x0000000043023a03, %g1, %g2
stx %g2, [%g3]
call      main_pio
nop

setx 0x0000000053004f04, %g1, %g2
stx %g2, [%g3]
call      main_pio
nop

setx 0x0000000064035c05, %g1, %g2
stx %g2, [%g3]
call      main_pio
nop

setx 0x0000000073006e06, %g1, %g2
stx %g2, [%g3]
call      main_pio
nop

setx 0x0000000010000b07, %g1, %g2
stx %g2, [%g3]
call      main_pio
nop

setx 0x0000000021011e08, %g1, %g2
stx %g2, [%g3]
call      main_pio
nop

setx 0x0000000032002f09, %g1, %g2
stx %g2, [%g3]
call      main_pio
nop

setx 0x0000000041023e0a, %g1, %g2
stx %g2, [%g3]
call      main_pio
nop

setx 0x000000005200400b, %g1, %g2
stx %g2, [%g3]
call      main_pio
nop

setx 0x0000000061035e0c, %g1, %g2
stx %g2, [%g3]
call      main_pio
nop

setx 0x000000007200600d, %g1, %g2
stx %g2, [%g3]
call      main_pio
nop

ba  end_now   ! test passed if u are here
nop
