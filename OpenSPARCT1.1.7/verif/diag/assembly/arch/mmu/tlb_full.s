...
* 
* OpenSPARC T1 Processor File: tlb_full.s
...
load_dtlb2:
	...
	mov	0x30,	%l3
        ...
        stxa    %g5,    [%g0] 0x5C	/* data in reg VA=0 non-real entry */
        stxa    %g5,    [%i5] 0x5C	/* data in reg VA=0 non-real entry */

        stxa    %i5,    [%l5] 0x5C	/* data in reg VA=200 real entry no auto demap should occur*/
...
dtsb_table1:
        ...
        .xword  0xF000000000400000,     0xe000000100400002	/* 3 */ 
        /*   nucleus context : V=1,0 L=1, size=512k, G=0  */
        .xword  0xE000000008400000,     0xe000000100480042	/* 4 */
        /*   nucleus context : V=1,0 L=1, size=64k, G=0  */
        .xword  0xD000000001090000,     0xa000000100490042	/* 5 */
        /*   nucleus context : V=1,0 L=0, size=8k, G=0  */
        .xword  0xC000000002492000,     0x8000000100492092	/* 6 */
        /*   nucleus context : V=1,0 L=1, size=512k, G=0  */
        .xword  0xA000000014480000,     0xe000000100480042	/* 7 */
        /*   nucleus context : V=1,0 L=0, size=8k, G=0  */
        .xword  0x9000000020492000,     0x8000000100492092	/* 8 */
        /*   nucleus context : V=1,0 L=1, size=64k, G=0  */
        .xword  0x8000000040490000,     0xa000000100490042	/* 9 */
        /*   nucleus context : V=1,0 L=1, size=512k, G=0  */
        .xword  0x7000000080480000,     0xe000000100480042	/* 10 */
        /*   nucleus context : V=1,0 L=0, size=4mb, G=0  */
        .xword  0x6000000100400000,     0xe000000100400002	/* 11 */ 
        /*   nucleus context : V=1,0 L=1, size=64k, G=0  */
        .xword  0x5000000000490000,     0xa000000100490042	/* 12 */

        /*   primary context : V=1,0 L=0, size=4mb, G=0  */
        .xword  0x4000000200400044,     0xe000000100400002	/* 13 */ 
        /*   primary context : V=1,0 L=1, size=512k, G=0  */
        .xword  0x3000000400480044,     0xe000000100480042	/* 14 */
        /*   primary context : V=1,0 L=1, size=64k, G=0  */
        .xword  0x2000000800490044,     0xa000000100490042	/* 15 */
        /*   primary context : V=1,0 L=0, size=8k, G=0  */
        .xword  0x1000001000492044,     0x8000000100492092	/* 16 */
        /*   primary context : V=1,0 L=1, size=512k, G=0  */
        .xword  0x0F00002000480044,     0xe000000100480042	/* 17 */
        /*   primary context : V=1,0 L=0, size=8k, G=0  */
        .xword  0x0E00004000492044,     0x8000000100492092	/* 18 */
        /*   primary context : V=1,0 L=1, size=64k, G=0  */
        .xword  0x0D00008000490044,     0xa000000100490042	/* 19 */
        /*   primary context : V=1,0 L=1, size=512k, G=0  */
        .xword  0x0C00010000480044,     0xe000000100480042	/* 20 */
        /*   primary context : V=1,0 L=0, size=4mb, G=0  */
        .xword  0x0B00011000400044,     0xe000000100400002	/* 21 */ 
        /*   primary context : V=1,0 L=1, size=64k, G=0  */
        .xword  0x0A00012000490044,     0xa000000100490042	/* 22 */

        /*   secondary  context : V=1,0 L=0, size=4mb, G=0  */
        .xword  0x0900014000400055,     0xe000000100400002	/* 23 */ 
        /*   secondary  context : V=1,0 L=1, size=512k, G=0  */
        .xword  0x0800018000480055,     0xe000000100480042	/* 24 */
        /*   secondary  context : V=1,0 L=1, size=64k, G=0  */
        .xword  0x0700018100490055,     0xa000000100490042	/* 25 */
        /*   secondary  context : V=1,0 L=0, size=8k, G=0  */
        .xword  0x0600018200492055,     0x8000000100492092	/* 26 */
        /*   secondary  context : V=1,0 L=1, size=512k, G=0  */
        .xword  0x0500014100480055,     0xe000000100480042	/* 27 */
        /*   secondary  context : V=1,0 L=0, size=8k, G=0  */
        .xword  0x0300014200492055,     0x8000000100492092	/* 28 */
        /*   secondary  context : V=1,0 L=1, size=64k, G=0  */
        .xword  0x0200014800490055,     0xa000000100490042	/* 29 */
        /*   secondary  context : V=1,0 L=1, size=512k, G=0  */
        .xword  0x0100012800480055,     0xe000000100480042	/* 30 */
        /*   secondary  context : V=1,0 L=0, size=4mb, G=0  */
        .xword  0x00F0011100400055,     0xe000000100400002	/* 31 */ 
        /*   secondary  context : V=1,0 L=1, size=64k, G=0  */
        .xword  0x00E0010300490055,     0xa000000100490042	/* 32 */

	/*   nucl context : L=0, size=4M, G=0  */
	.xword	0x00D0000010400000,	0xe000000100400002		/* 33 */
	.xword	0x00C0000010800000,	0x6000000100800002		/* 34 */

	/*   prim context : L=0, size=4M, G=0  */
	.xword	0x00B0000010400044,	0xe000000100400002		/* 35 */
	.xword	0x00A0000010800044,	0x6000000100800002		/* 36 */

	/*   secondary context : L=0, size=4M, G=0  */
	.xword	0x0090000010400055,	0xe000000110400002		/* 37 */
	.xword	0x0080000010800055,	0x6000000100800002		/* 38 */

	/*   nucl context : L=1, size=64k, G=0  */
	.xword	0x0070000011a30000,	0xa000000101a30042		/* 39 */
	.xword	0x0060000011a40000,	0x2000000101a40042		/* 40 */

	/*   prim context : L=1, size=64k, G=0  */
	.xword	0x0050000011a30044,	0xa000000101a30042		/* 41 */
	.xword	0x0040000011a40044,	0x2000000101a40042		/* 42 */

	/*   secondary context : L=1, size=64k, G=0  */
	.xword	0x0030000011a30055,	0xa000000101a30042		/* 43 */
	.xword	0x0020000011a40055,	0x2000000101a40042		/* 44 */

	/*   secondary context : L=1, size=64k, G=1  */
	.xword	0x0010000011a50055,	0xa000000101a50043		/* 45 */
	.xword	0xF010000011a60055,	0x2000000101a60043		/* 46 */

	/*   secondary context : L=1, size=512k, G=1  */
	.xword	0xF010000011b80055,	0xe000000101b80043		/* 47 */
#if 0
	.xword	0xF010000011c00055,	0x60000001010c0043		/* 48 */
#endif

	/*   secondary context : L=1, size=4M, G=0  */
	.xword	0xF020000011400055,	0xe000000101400042		/* 49 */
	.xword	0xF030000011800055,	0x6000000101800042		/* 50 */

	/*   secondary context : L=1, size=4M, G=1  */
	.xword	0xF040000011c00055,	0x6000000101c00043		/* 51 */
	.xword	0xF050000012000055,	0xe000000102000043		/* 52 */

	/*   primary context : V=1,0 L=0, size=8k, G=0  */
	.xword	0xF060000012080044,	0x8000000102080002		/* 53 */
	.xword	0xF070000012100044,	0x0000000102100002		/* 54 */

	/*   primary context : L=0, size=8k, G=1  */
	.xword	0xF080000012110044,	0x8000000102110003	/* 55 */
	.xword	0xF090000012120044,	0x0000000102120003		/* 56 */

	/*   primary context : L=0, size=64k, G=0  */
	.xword	0xF0A0000012130044,	0xa000000102130002		/* 57 */
	.xword	0xF0B0000012140044,	0x2000000102140002		/* 58 */

	/*   primary context : L=0, size=64k, G=1  */
	.xword	0xF0C0000012150044,	0xa000000102150003		/* 59 */
	.xword	0xF0D0000012160044,	0x2000000102160003		/* 60 */

	/*   primary context : L=0, size=512k, G=0  */
	.xword	0xF110000012200044,	0xe000000102200002		/* 61 */
	.xword	0xF110000012280044,	0x6000000102280002		/* 62 */

	/*   primary context : L=0, size=512k, G=1  */
	.xword	0xF120000012300044,	0xe000000102300003		/* 63 */
	.xword	0xF120000012380044,	0x6000000102380003		/* 64 */

	/*   primary context : L=0, size=4M, G=0  */
	.xword	0xF130000012400044,	0xe000000102400002		/* 62 */
	.xword	0xF130000012800044,	0x6000000102800002		/* 1 */

	/*   nucleus context : L=0, size=64k, G=0  */
	.xword	0xFF000000051a0000,	0xa0000001051a0002		/* 64 */
	.xword	0xFF000000051b0000,	0x20000001051b0002		/* 1 */

	/*   nucleus context : L=0, size=64k, G=1  */
	.xword	0xFE000000051c0000,	0xa0000001051c0003		/* 1 */
	.xword	0xFD000000051d0000,	0x20000001051d0003		/* 1 */

	/*   nucleus context : L=0, size=512k, G=0  */
	.xword	0xFC00000000200000,	0xe000000100200002		/* 1 */
	.xword	0xFB00000000280000,	0x6000000100280002		/* 1 */

	/*   nucleus context : L=0, size=512k, G=1  */
	.xword	0xFA00000000300000,	0xe000000100300003		/* 1 */
	.xword	0xF900000000380000,	0x6000000100380003		/* 1 */

	/*   nucleus context : L=0, size=4M, G=0  */
	.xword	0xF800000000400000,	0xe000000100400002		/* 1 */
	.xword	0xF700000000800000,	0x6000000100800002		/* 1 */

	/*   nucleus context : L=0, size=4M, G=1  */
	.xword	0xF600000000c00000,	0xe00000010c000003		/* 1 */
	.xword	0xF500000001000000,	0x6000000110000003		/* 1 */

	/*   nucleus context : V=1,0 L=1, size=8k, G=0  */
	.xword	0xF400000001a10000,	0x8000000101a10042		/* 1 */
	.xword	0xF300000001a18000,	0x0000000101a18042		/* 1 */

	/*   nucleus context : L=1, size=8k, G=1  */
	.xword	0xF200000001a20000,	0x8000000101a20043	/* 1 */
	.xword	0xF100000001a28000,	0x0000000101a28043		/* 1 */
