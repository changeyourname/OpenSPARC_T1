...
* 
* OpenSPARC T1 Processor File: tlb_dmp0.s
...
write_read_dtlb:
	...
	mov	0x0,	%l2
	mov	0x0,	%l1
	mov	0x5,	%l5	/* skip the first 5 entries */
	sll	%l5,	3,	%l5
...
dtsb_table1:
	...
	.xword	0x00000000051a0000,	0xa0000001051a0041	
	.xword	0x00000000051b0000,	0x80000001051b0041	/* cause auto-demap */	
	/*   prim context : L=0, size=64k, G=0  */
	.xword	0x00000000051a0044,	0xa0000001051a0041	
	.xword	0x00000000051b0044,	0x80000001051b0041	/* cause auto-demap */	

	/*   nucleus context : V=1,0 L=0, size=8k, G=0  */
	.xword	0x0000000005180000,	0x8000000105180041	
	.xword	0x0000000005180000,	0xa000000105180041	/* cause auto-demap */	
	/*   prim context : V=1,0 L=0, size=8k, G=0  */
	.xword	0x0000000005180044,	0x8000000105180041	
	.xword	0x0000000005180044,	0xa000000105180041	/* cause auto-demap */	

	/*   nucleus context : L=0, size=8k, G=1  */
	.xword	0x0000000005190000,	0x8000000105190043
	.xword	0x0000000005198000,	0x8000000105198043	
	/*   prim context : L=0, size=8k, G=1  */
	.xword	0x0000000005190044,	0x8000000105190043
	.xword	0x0000000005198044,	0x8000000105198043	

	/*   nucleus context : L=0, size=8k, G=1  */
	.xword	0x00000000051c0000,	0x80000001051c0043	
	.xword	0x00000000051d0000,	0x80000001051d0043	
	/*   prim context : L=0, size=8k, G=1  */
	.xword	0x00000000051c0044,	0x80000001051c0043	
	.xword	0x00000000051d0044,	0x80000001051d0043	
