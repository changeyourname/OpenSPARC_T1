...
* 
* OpenSPARC T1 Processor File: hp_dmmu_nzctx_ptr_ext.s
...
dtsb_8:
	...
	add	%l1,	0x0,	%l1	/* TSB_size = 4'b1000 */
	set	0x1000,	%l3
	or	%l3,	%l1,	%l1	
...
dtsb_9:
	...
	mov	0x8,	%o0	/* test case 8 */
	setx	DTSB_BASE1,	%l0,	%l1
	add	%l1,	0x1,	%l1	/* TSB_size = 4'b1001 */
	set	0x1000,	%l3
	or	%l3,	%l1,	%l1	
...
dtsb_10:
        ...
        setx    DTSB_BASE2,     %l0,    %l1
        add     %l1,    0x2,    %l1     /* TSB_size = 4'b1010 */
        set     0x1000, %l3
        or     %l3,    %l1,    %l1
...
dtsb_11:
        ...
        setx    DTSB_BASE3,     %l0,    %l1
        add     %l1,    0x3,    %l1     /* TSB_size = 4'b1011 */
        set     0x1000, %l3
        or     %l3,    %l1,    %l1
...
dtsb_12:
        /*
         ***************************************
         * split = 1 , dtsb_size = 4'b1100
         ***************************************
         */
        mov     0xb,    %o0     /* test case 11 */
        setx    DTSB_BASE4,     %l0,    %l1
        add     %l1,    0x4,    %l1     /* TSB_size = 4'b1100 */
        set     0x1000, %l3
        or     %l3,    %l1,    %l1
...
dtsb_13:
        /*
         ***************************************
         * split = 1 , dtsb_size = 4'b1101
         ***************************************
         */
        mov     0xc,    %o0     /* test case 12 */
        setx    DTSB_BASE5,     %l0,    %l1
        add     %l1,    0x5,    %l1     /* TSB_size = 4'b1101 */
        set     0x1000, %l3
        or     %l3,    %l1,    %l1
...
dtsb_14:
        /*
         ***************************************
         * split = 1 , dtsb_size = 4'b1110
         ***************************************
         */
        mov     0xd,    %o0     /* test case 13 */
        setx    DTSB_BASE6,     %l0,    %l1
        add     %l1,    0x6,    %l1     /* TSB_size = 4'b1110 */
        set     0x1000, %l3
        or     %l3,    %l1,    %l1
...
dtsb_15:
        /*
         ***************************************
         * split = 1 , dtsb_size = 4'b1111
         ***************************************
         */
        mov     0xe,    %o0     /* test case 14 */
        setx    DTSB_BASE7,     %l0,    %l1
        add     %l1,    0x7,    %l1     /* TSB_size = 4'b1111 */
        set     0x1000, %l3
        or     %l3,    %l1,    %l1
...
#define 	VA_MISS_ADDR6	0x00005555aaaa5555
	...
	/* 
	 **********************************************
	 * split = 0,1;  dtsb_size 4'b1001 ~ 4'b1111 
	 **********************************************
	 */
	mov	0x0,	%o6
	stxa	%l1,	[%o6] 0x39	/* change DMMU_CTX_NONZERO_TSB_BASE_PS0 reg */
	stxa	%l1,	[%o6] 0x3a	/* change DMMU_CTX_NONZERO_TSB_BASE_PS1 reg */
