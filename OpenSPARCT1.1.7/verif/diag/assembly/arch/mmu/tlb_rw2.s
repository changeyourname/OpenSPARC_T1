...
* 
* OpenSPARC T1 Processor File: tlb_rw2.s
...
write_read_dtlb:
	mov	0x3d,	%l0
	mov	0x0,	%l1
	mov	0x48,	%l5	/* skip the first 9 entries */
...
readout_dtlb1:
        ...
        set     0x0,    %l0
        set     0x40,   %l6
        set     0x48,    %l7	/* read out entry 3 , counting from 0 , the forth entry */
rdout_dtlb1_loop:
        ldxa    [%l7] 0x5d,     %l3
        ldxa    [%l7] 0x5e,     %l4
 ...
 */
        ...
        setx    0xe000000100180040, %l0, %l4    /* lock bit set */
