...
* 
* OpenSPARC T1 Processor File: hp_immu_realpgdmp.s
...
main:
	 ...
	 */
test_1:
        mov     0x1e,   %l0	/* 2 writes each time, one for non-real txlation, one for real txlation */
        mov     0x0,    %l1
...
preload_itlb1:
	...
	set	0x208,	%l7
        ...
        stxa    %g5,    [%l5] 0x55      /* IMMU data access reg , non-real pg */

        stxa    %g4,    [%l3] 0x50      /* IMMU tag access reg */
        stxa    %g5,    [%l7] 0x55      /* IMMU data access reg , real pg */
