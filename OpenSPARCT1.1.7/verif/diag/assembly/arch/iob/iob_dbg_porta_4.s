...
* 
* OpenSPARC T1 Processor File: iob_dbg_porta_4.s
...
/* Select iob decode header. */                        
sel_iob_dec_hdr:
        setx    0x0000000000000104,     %l0,    %l1     ! Write to db enet control register.
        setx    0x0000009800002000,     %l0,    %l2     ! Set db enet control register address.
        stx     %l1,    [%l2]        
        membar  #Sync
        ldx     [%l2],  %l1
                
        set     0x3e,   %o0     ! Skip selections.
