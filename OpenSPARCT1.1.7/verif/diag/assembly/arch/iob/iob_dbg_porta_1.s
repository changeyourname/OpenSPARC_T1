...
* 
* OpenSPARC T1 Processor File: iob_dbg_porta_1.s
...
/* Select l2 cache port with time stamp. */                                        
sel_l2_cache_port_ts:
        setx    0x0000000000000101,     %l0,    %l1     ! Write to db enet control register.
        setx    0x0000009800002000,     %l0,    %l2     ! Set db enet control register address.
        stx     %l1,    [%l2]
        membar  #Sync
        ldx     [%l2],  %l1
