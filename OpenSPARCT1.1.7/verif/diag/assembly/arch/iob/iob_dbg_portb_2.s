...
* 
* OpenSPARC T1 Processor File: iob_dbg_portb_2.s
...
/* Select hi l2 cache port and low iob with flag field. */
sel_lo_iob_flag:
        setx    0x0000000000010003,     %l0,    %l1     ! Write to db jbus control register.
        setx    0x0000009800002100,     %l0,    %l2     ! Set db jbus control register address.
        stx     %l1,    [%l2]
        membar  #Sync
        ldx     [%l2],  %l1
        
        set     0x6,    %o0     ! Skip selections.
