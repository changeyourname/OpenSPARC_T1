...
* 
* OpenSPARC T1 Processor File: iob_reg_mt_2.s
...
rw_reg_loop_19:
        ...
        setx    0xffffffffffffffff,     %l0,    %o4     ! Register write mask.
        setx    0x000000000000003e,     %l0,    %o5     ! Skip pattern.
        call    sub_rw_reg
        save        
        nop
        add     %g1,    0x1,   %g1
...
rw_reg_loop_0:
        ...
        ! ld/st to IOB registers.
        setx    0x0000008000010098,     %l0,    %o0     ! Register address.
        setx    0x0000000000000001,     %l0,    %o1     ! Number of registers.
        setx    0x0000000000000000,     %l0,    %o2     ! Step.
        setx    0x00000000ffffffff,     %l0,    %o3     ! Register read mask.
        setx    0x00000000ffffffff,     %l0,    %o4     ! Register write mask.
        setx    0x0000000000000000,     %l0,    %o5     ! Skip pattern.	
        call    sub_rw_reg
        save        
        nop
