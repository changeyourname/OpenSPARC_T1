...
* 
* OpenSPARC T1 Processor File: iob_int_dram_thd.s
...
th_main_0:    
	...
	! Initialize jbi registers.
        ...
        ! Initialize iob interrupt registers.
        set     THREAD_STRIDE,  %l3     ! Thread stride.
        sll     %l3,    0x8,    %l3
        
        setx    0x0000009800000008,     %l0,    %l1     ! Set interrupt management register address.
        setx    0x0000000000000001,     %l0,    %l2     ! Write to interrupt management register.
        or      %l2,    %l3,    %l2
        stx     %l2,    [%l1]
