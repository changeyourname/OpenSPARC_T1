...
* 
* OpenSPARC T1 Processor File: iob_int_jbi.s
...
trap_interrupt_jbi:
        ...
        ! Clear interrupt busy bit and issue sync cycle depending on
        ! interrupt source id.
...
check_sjm_4:                  
        ...
        ldx     [%g2],  %g3
        setx    0x980217998A0A1E77,     %l0,    %g4
        cmp     %g4,    %g3
        bne     trap_diag_fail
        nop
        setx    0x0000009f00000700,     %g1,    %g2
        ldx     [%g2],  %g3
        setx    0x97FF7430DE054BB9,     %l0,    %g4
        cmp     %g4,    %g3
        bne     trap_diag_fail
        nop
...
check_sjm_5:                  
        setx    0x0000009f00000600,     %g1,    %g2
        ldx     [%g2],  %g3
        setx    0xD84FA62D4E4E83C9,     %l0,    %g4
        cmp     %g4,    %g3
        bne     trap_diag_fail
        nop
        setx    0x0000009f00000700,     %g1,    %g2
        ldx     [%g2],  %g3
        setx    0xF4D586F9A2F4743B,     %l0,    %g4
        cmp     %g4,    %g3
        bne     trap_diag_fail
        nop
