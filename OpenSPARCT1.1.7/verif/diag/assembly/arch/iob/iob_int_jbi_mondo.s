...
* 
* OpenSPARC T1 Processor File: iob_int_jbi_mondo.s
...
th_main_0:    
	...
	! Initialize jbi interrupt vector.        
        ...
        ! Clear %l6 and %l7 which will be used as trap counters.
        set     0x0,    %l6
        set     0x0,    %l7
...
iosync_sjm_4:
        ...
        ! Check that the mondo data are updated correctly.        
        mov     %l6,    %g1
        add     %l6,    0x1,   %l6        
        set     0x0,    %g2
        cmp     %g1,    %g2
