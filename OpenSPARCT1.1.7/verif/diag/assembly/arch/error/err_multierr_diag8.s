...
* 
* OpenSPARC T1 Processor File: err_multierr_diag8.s
...
create_l2_CE:
  ...
  add   %g1, 0x10, %l1          ! CE on the second returning CPX packet
...
create_l2_UE:
  ! Read L2 Data Diag
  ! Addressing: [39:32] See PRM, [22] odd/even word, [21:18] way, [17:8] set, [7:6] bank, [5:3] D-word, [2:0] = 0
  add   %g1, 0x20, %l1          ! UE on the third returning CPX packet
  setx  0x3ffff8, %l0, %l2      ! Mask for extracting [21:3]
  and   %l1, %l2, %g5
...
load_MA_MEM:
  sllx  %g3, 11, %l0                       ! set THREAD_ID field
  or    %i0, %l0, %i0
  stxa  %i0, [%g0+REG_MA_CTL_ADDR] %asi    ! store to the MA_CTL register to load 9 xwords to MAMEM
  ...
  sllx  %l1, L2ES_VEC, %l3
  or    %l0, %l3, %l0
  mov   0x2, %l1                 ! 7-bit Syndrome (for the UE)
