...
* 
* OpenSPARC T1 Processor File: err_icache_data_cecc.s
...
! This address [11:5] will create a cache set of 0x2f (47).
...
#define  ITLB_ENTRY_VA     0x200045e0
...
error_address:
  ...
  ! The call should cause an I-Cache parity error being detected.
...
check_ASI_instr_load:
  ...
  add   %l2, 0x10, %l2
  ldxa  [%l2] ASI_ICACHE_INSTR, %l1  ! Read the fifth word
  setx  0xdeadbeef, %l4, %l3
  cmp   %l1, %l3
  bne   test_fail                    ! Note: compare only %icc not %xcc
...
itlb_entry:
  ...
  .xword  0x0000000020004044,  0x8000001130004023
