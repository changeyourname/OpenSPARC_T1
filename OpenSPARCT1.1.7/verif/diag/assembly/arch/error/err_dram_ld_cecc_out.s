...
* 
* OpenSPARC T1 Processor File: err_dram_ld_cecc_out.s
...
#define  L2_ENTRY_PA        0x200730010
#define  L2_BANK_ADDR       0x40
#define  DRAM_CHANNEL_ADDR  0x1000
#define  TEST_DATA          0x1000000081c3e010
...
store_without_errors:
  stx   %g3, [%g1]

  add   %l0, %g2, %l0
  mov   0x8, %l1                ! ECC Mask (1-bit error)
  mov   0x1, %l2
...
check_l2_EAR:
  ...
  andn  %g1, 0x3f, %l1
  andn  %l4, 0x3f, %l4          ! But EAR[5:0] not guaranteed to be zero (see PRM)
  cmp   %l4, %l1
  bne   %xcc, test_fail
  nop
