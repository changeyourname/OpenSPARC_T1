...
* 
* OpenSPARC T1 Processor File: err_mamem_data10.s
...
load_MA_MEM:
  ...
  ! If trap level not 0, skip interrupt enable
  rdpr  %tl, %l0
  brnz  %l0, MA_Multiply
  nop
...
scmp_label_2:
  ...
  ! If MA interrupt did not happen, this test wouldn't have passed
...
My_Modular_Arithmetic_interrupt:
  ...
  rdpr  %tt, %o6
  ! Repeat MA operation without error and without interrupt
  ba    set_up_addresses
  nop
