...
* 
* OpenSPARC T1 Processor File: tso_self_mod3.s
...
modify1:
	...
	ld	[%i0],%l0       
	st	%l0,[%i1]
	flush	%i1 		!update the I$ to be consistent with the E$
...
! these threads are trying to steal the lines that are being modified.
main_1:
main_4:
