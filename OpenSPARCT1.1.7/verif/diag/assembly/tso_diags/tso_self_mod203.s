...
* 
* OpenSPARC T1 Processor File: tso_self_mod203.s
...
/***************************************************************************
***
***  Program File: tso_self_modify203.s
***
***  Objective        : test which self-modifies its code and tries to stress
***                     this process. uses CAS instr. to do the self-modify.
*** 			Another test is trying to steal the modified lines.
***
**********************************************************************/
