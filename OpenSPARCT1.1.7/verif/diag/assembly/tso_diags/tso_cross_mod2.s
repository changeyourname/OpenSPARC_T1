...
* 
* OpenSPARC T1 Processor File: tso_cross_mod2.s
...
th_main_0:
	...
	setx 	noop, 	  %l0, %l2
	ldda    [%l2]ASI_BLK_P, %d0	! nop-s in d0 to d15
	setx 	modified, %l0, %l3	!
...
deliver_loop:
	...
	flush	%l3			! the reg here does not matter.
...
th_main_4:
	...
	setx 	ready, %l0, %l1		! pointers...
	setx 	bad_end, %l0, %l2
	ldda    [%l2]ASI_BLK_P, %d0	! ta BAD_TRAP is d0-d15
	setx 	modified, %l0, %l3
...
modified:
	...
	stda	%d0, [%l3]ASI_BLK_P	! store bad data to label0 again
	membar	0x40
