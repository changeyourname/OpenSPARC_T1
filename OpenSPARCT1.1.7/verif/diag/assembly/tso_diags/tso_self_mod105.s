...
* 
* OpenSPARC T1 Processor File: tso_self_mod105.s
...
****************************************************************************
***
***  Program File: tso_self_mod105.s
***
***  Objective        : quasi-random self-modifying test
*** 			try I$/D$ exclusivity also.
***
...
label0:
	...
	ld	[%o0], %i2		! bring to D$
	ld	[%o0 + 0x14], %i2	! bring to D$
	ld	[%o0 + 0x20], %i2	! bring to D$
	ld	[%o0 + 0x38], %i2	! bring to D$
	ld	[%o0 + 0x40], %i2	! bring to D$
