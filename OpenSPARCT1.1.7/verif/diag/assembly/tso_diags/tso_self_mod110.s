...
* 
* OpenSPARC T1 Processor File: tso_self_mod110.s
...
/***************************************************************************
***
***  Program File: tso_self_mod110.s
***
***  Objective        : quasi random self modifying test.
***			test I$/D$ exclusivity also. Use block stores
***
**********************************************************************/
...
!	ld	[%o0], %i2
	ld	[%o0 +0x10], %i2	! some random loads of the Istream
	ld	[%o0 + 0x20], %i2
	ld	[%o0 + 0x30], %i2
	ld	[%o1], %i2
!	ld	[%o1 +0x10], %i2
