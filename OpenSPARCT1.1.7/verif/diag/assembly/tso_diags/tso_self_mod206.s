...
* 
* OpenSPARC T1 Processor File: tso_self_mod206.s
...
/***************************************************************************
***
***  Program File: tso_self_mod206.s
***
***  Objective        : quasi-random self-modifying test. ises CAS.
***
***
**********************************************************************/
...
label7:
	...
	ld	[%o5], %i2		! 
	ld	[%o6], %i2		! 
	st	%i1, [%o0]		! store deadbeef to all labels
	st	%i1, [%o1]		!
	st	%i1, [%o2]		!
	st	%i1, [%o3]		!
	st	%i1, [%o4]		!
