...
* 
* OpenSPARC T1 Processor File: tso_self_mod104.s
...
/***************************************************************************
***
***  Program File: tso_self_mod104.s
***
***  Objective        : quasi-random self-modifying test
***			try the D$/I$ exclusivity also.
*** 
...
label0:
	...
	ld	[%o0], %i2		! ld in D$
	ld	[%o0 + 0x10], %i2	! ld in D$
	ld	[%o0 + 0x2c], %i2	! ld in D$
	ld	[%o0 + 0x3c], %i2	! ld in D$
	ld	[%o0 + 0x44], %i2	! ld in D$
