...
* 
* OpenSPARC T1 Processor File: tso_self_mod108.s
...
label0:
	ta	T_BAD_TRAP		! 
	ld	[%o1], %i2		! load brings the line at label1 to D$
	st	%i0, [%o1]		! store a nop to label1
	flush 	%o0			! 
label1:				
	ta	T_BAD_TRAP		! here the I$/D$ exclusivity mechanism
	ld	[%o2], %i2		! should kick in.
	st	%i0, [%o2] 		! e.t.c.
	flush 	%o0			! 
label2:
	ta	T_BAD_TRAP		!
