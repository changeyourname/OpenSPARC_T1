...
* 
* OpenSPARC T1 Processor File: tso_self_mod201.s
...
/***************************************************************************
***
***  Program File: tso_self_mod201.s
***
***  Test Description - self-modifying code using cas instruction to perform
...
modifyCodeAtMain1:
	...
	set	main1,%i1  	! change data at main
	ld	[%i1],%l0	! bring to D$ for testing
	ld	[%i0],%l0
	st	%i1, [%i1]
	cas	[%i1], %i1, %l0 ! cas should succeed here and modify the code
	flush	%i0 		! flush
