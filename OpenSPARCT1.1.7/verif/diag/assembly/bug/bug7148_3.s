...
* 
* OpenSPARC T1 Processor File: bug7148_3.s
...
#define SUN_H_HT0_data_access_protection_0x6c \
   mov 0x3f0, %l0; mov 0xde, %o7; set 0xbeef, %l5; ldxa  [%l0]0x25, %l5; done
...
/* to simplify things: scp-pad: 0xde; mondo: 0xc0 */
       mov     0xde, %g7
       cmp     %l5, %g7
       be      fail
       mov     0xc0, %g7
