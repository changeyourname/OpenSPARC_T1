...
* 
* OpenSPARC T1 Processor File: bug7148_1.s
...
#define SUN_H_HT0_data_access_protection_0x6c \
   mov 0x3c0, %l0; mov 0xde, %o7; set 0xbeef, %l5; ldxa  [%l0]0x25, %l5; done
...
back_to_main:
       ...
       mov    0x17, %o7
       mov    0x02, %l6
       mov    0x3c0, %l0             !-- asi_va = 0x3c0
       stxa    %g0, [%l0]0x25      !-- write (get away X)
...
set_va_watchpoint:
       ta      T_CHANGE_HPRIV
       nop
       ldxa    [%g0]0x45, %g1          !-- ASI_LSU_CTL
       !!setx    0x00000001fe000000, %l0, %l1
       mov     0xff, %l1
       sllx    %l1, 25, %l1            !-- 32:25 : vm mask
       set     0x01ffffff, %l2
       and     %l2, %g1, %g1           !-- bits[24:0]
       or      %l1, %g1, %g1           !-- [32:25]=1
       mov     0x3, %l1
       sll     %l1, 21, %l1
       or      %l1, %g1, %g1           !-- bit 21 VW, VR-22
       stxa    %g1, [%g0]0x45

       !-- ASI_DMMU_VA_WATCHPOINT: asi:0x58,va=0x38
       set 0x60002a50, %g1  !-- need be data address!!
       mov  0x38, %l1
       stxa %g1, [%l1]0x58
