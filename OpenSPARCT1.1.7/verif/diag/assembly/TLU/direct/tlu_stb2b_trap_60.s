...
* 
* OpenSPARC T1 Processor File: tlu_stb2b_trap_60.s
...
!! No. Threads: 1
!! Description: 
!! This diag tests the stb2b lsu-asynchronous and HW-interrupt
!! traps
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
wait_y3:
	...
	nop
hwint_1:
!$EV trig_pc_d(0,expr(@VA(.MAIN.hwint_1), 16, 16)) -> intp(0, 0, 0, 0, 1)
!$EV trig_pc_d(0,expr(@VA(.HTRAPS.HT0_Interrupt_0x60) + 4, 16, 16)) -> intp(0, 0, 0, 0, 1); \
	sth	%l2, [%l0]
	nop
	nop
	nop
