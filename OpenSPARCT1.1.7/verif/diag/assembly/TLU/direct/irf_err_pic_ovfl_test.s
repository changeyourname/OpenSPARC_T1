...
* 
* OpenSPARC T1 Processor File: irf_err_pic_ovfl_test.s
...
main:
	...
	add	%l4, 1, %l4
irf_ce:
!$EV error(%y,expr(@VA(.MAIN.irf_ce), 16, 16),1,IRF,ce,1,x, x,x,x, x,x,x)
	add	%l4, 1, %l4
pic_ovfl:
!$EV error(%y,expr(@VA(.MAIN.pic_ovfl), 16, 16),1,IRF,ce,1,x, x,x,x, x,x,x)
	add	%l6, %l4, %l6
	mov	0, %g1
	add	%g1, 0x4f, %g1
	cmp	%l6, %g1
