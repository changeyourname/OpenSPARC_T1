...
* 
* OpenSPARC T1 Processor File: tlu_multi_intl_13.s
...
main_th_3:
	nop
!!-------------------------------------
!! tick/stick/htick-match in Hypervisor
!!-------------------------------------
...
wait_1:
	...
	wrhpr	%g0, 0, %hintp
!!-------------------------------------
!! tick/stick/htick-match in Supervisor
!!-------------------------------------
	!ta	T_CHANGE_HPRIV	! macro
	setx	0x4000000000000000, %g1, %g1
	!wrpr	%g0, %pil
...
wait_2:
	...
	wrpr	%l0, 4, %pstate
!!-------------------------------------
!! tick/stick/htick-match in User
!!-------------------------------------
	ta	T_CHANGE_HPRIV	! macro
	wrhpr	%g0, 0, %hintp
	setx	0x4000000000000000, %g1, %g1
