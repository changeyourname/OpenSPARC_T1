...
my $project = exists $ENV{PROJECT} ? $ENV{PROJECT} : "OpenSPARCT1";
our %proj_vars;
...
if ( $project eq 'OpenSPARCT1' ) {
	...
	"\n         only OpenSPARCT1 is supported, please do one of the following:" .
...
A hash called %proj_vars is exported, which has the following fields:
	...
	proj		the name of the project, OpenSPARCT1
