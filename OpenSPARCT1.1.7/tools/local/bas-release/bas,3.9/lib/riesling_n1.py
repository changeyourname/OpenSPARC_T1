...
# 
# OpenSPARC T1 Processor File: riesling_n1.py
...
_riesling_n1.Object_swigregister(ObjectPtr)
...
_riesling_n1.Exception_swigregister(ExceptionPtr)
...
class SparcArchViolation(Exception):
    ...
    def __init__(self, *args):
        _swig_setattr(self, SparcArchViolation, 'this', _riesling_n1.new_SparcArchViolation(*args))
...
_riesling_n1.SparcArchViolation_swigregister(SparcArchViolationPtr)
...
_riesling_n1.LogicError_swigregister(LogicErrorPtr)
...
class InvalidArgument(Exception):
    ...
    def __init__(self, *args):
        _swig_setattr(self, InvalidArgument, 'this', _riesling_n1.new_InvalidArgument(*args))
...
_riesling_n1.InvalidArgument_swigregister(InvalidArgumentPtr)
...
class LengthError(Exception):
    ...
    def __init__(self, *args):
        _swig_setattr(self, LengthError, 'this', _riesling_n1.new_LengthError(*args))
...
_riesling_n1.LengthError_swigregister(LengthErrorPtr)
...
class OutOfRange(Exception):
    ...
    def __init__(self, *args):
        _swig_setattr(self, OutOfRange, 'this', _riesling_n1.new_OutOfRange(*args))
...
_riesling_n1.OutOfRange_swigregister(OutOfRangePtr)
...
class DomainError(Exception):
    ...
    def __init__(self, *args):
        _swig_setattr(self, DomainError, 'this', _riesling_n1.new_DomainError(*args))
...
_riesling_n1.DomainError_swigregister(DomainErrorPtr)
...
_riesling_n1.FieldObject_swigregister(FieldObjectPtr)
...
class RegisterFile(Object):
    ...
    def __init__(self, *args):
        _swig_setattr(self, RegisterFile, 'this', _riesling_n1.new_RegisterFile(*args))
        _swig_setattr(self, RegisterFile, 'thisown', 1)
    def __del__(self, destroy=_riesling_n1.delete_RegisterFile):
        try:
...
_riesling_n1.RegisterFile_swigregister(RegisterFilePtr)
...
class FloatRegisterFile(Object):
    ...
    def __init__(self, *args):
        _swig_setattr(self, FloatRegisterFile, 'this', _riesling_n1.new_FloatRegisterFile(*args))
        _swig_setattr(self, FloatRegisterFile, 'thisown', 1)
    def __del__(self, destroy=_riesling_n1.delete_FloatRegisterFile):
        try:
            if self.thisown: destroy(self)
        except: pass
...
_riesling_n1.FloatRegisterFile_swigregister(FloatRegisterFilePtr)
...
class V9_TrapType(_object):
    ...
    def __init__(self, *args):
        _swig_setattr(self, V9_TrapType, 'this', _riesling_n1.new_V9_TrapType(*args))
...
_riesling_n1.V9_TrapType_swigregister(V9_TrapTypePtr)
...
_riesling_n1.InstructionWord_swigregister(InstructionWordPtr)
...
_riesling_n1.Hv_InstructionWord_swigregister(Hv_InstructionWordPtr)
...
_riesling_n1.V9_TickReg_swigregister(V9_TickRegPtr)
...
_riesling_n1.Sf_SoftIntReg_swigregister(Sf_SoftIntRegPtr)
...
_riesling_n1.V9_TickCompareReg_swigregister(V9_TickCompareRegPtr)
...
_riesling_n1.V9_CcrReg_swigregister(V9_CcrRegPtr)
...
_riesling_n1.V9_YReg_swigregister(V9_YRegPtr)
...
_riesling_n1.V9_FprsReg_swigregister(V9_FprsRegPtr)
...
_riesling_n1.V9_FsrReg_swigregister(V9_FsrRegPtr)
...
_riesling_n1.V9_TbaReg_swigregister(V9_TbaRegPtr)
...
_riesling_n1.V9_PilReg_swigregister(V9_PilRegPtr)
...
_riesling_n1.V9_AsiReg_swigregister(V9_AsiRegPtr)
...
_riesling_n1.V9_Tpc_swigregister(V9_TpcPtr)
...
_riesling_n1.V9_Tnpc_swigregister(V9_TnpcPtr)
...
_riesling_n1.V9_WstateReg_swigregister(V9_WstateRegPtr)
...
_riesling_n1.V9_TrapLevelReg_swigregister(V9_TrapLevelRegPtr)
...
_riesling_n1.V9_VerReg_swigregister(V9_VerRegPtr)
...
_riesling_n1.CMP_CoreAvailableReg_swigregister(CMP_CoreAvailableRegPtr)
...
_riesling_n1.CMP_CoreEnabledReg_swigregister(CMP_CoreEnabledRegPtr)
...
_riesling_n1.CMP_CoreEnableReg_swigregister(CMP_CoreEnableRegPtr)
...
_riesling_n1.CMP_CoreRunningReg_swigregister(CMP_CoreRunningRegPtr)
...
_riesling_n1.CMP_CoreRunningStatusReg_swigregister(CMP_CoreRunningStatusRegPtr)
...
_riesling_n1.CMP_ErrorSteeringReg_swigregister(CMP_ErrorSteeringRegPtr)
...
_riesling_n1.CMP_XirSteeringReg_swigregister(CMP_XirSteeringRegPtr)
...
_riesling_n1.CMP_CpuLevelCmpRegs_swigregister(CMP_CpuLevelCmpRegsPtr)
...
_riesling_n1.MemoryInterface_swigregister(MemoryInterfacePtr)
...
class SparseMemory(_object):
    ...
    def __init__(self, *args):
        _swig_setattr(self, SparseMemory, 'this', _riesling_n1.new_SparseMemory(*args))
...
_riesling_n1.SparseMemory_swigregister(SparseMemoryPtr)
...
_riesling_n1.BreakpointTable_swigregister(BreakpointTablePtr)
...
_riesling_n1.Ni_IDPartitionIdReg_swigregister(Ni_IDPartitionIdRegPtr)
...
_riesling_n1.Sf_ContextReg_swigregister(Sf_ContextRegPtr)
...
_riesling_n1.Sf_TagTargetReg_swigregister(Sf_TagTargetRegPtr)
...
_riesling_n1.Sf_TagAccessReg_swigregister(Sf_TagAccessRegPtr)
...
_riesling_n1.Ni_Mmu_swigregister(Ni_MmuPtr)
...
_riesling_n1.Ni_InstructionWord_swigregister(Ni_InstructionWordPtr)
...
class Ni_TstateEntry(_object):
    ...
    def __init__(self, *args):
        _swig_setattr(self, Ni_TstateEntry, 'this', _riesling_n1.new_Ni_TstateEntry(*args))
...
_riesling_n1.Ni_TstateEntry_swigregister(Ni_TstateEntryPtr)
...
_riesling_n1.Ni_Tstate_swigregister(Ni_TstatePtr)
...
_riesling_n1.Ni_PstateReg_swigregister(Ni_PstateRegPtr)
...
class Hv_HtstateEntry(_object):
    ...
    def __init__(self, *args):
        _swig_setattr(self, Hv_HtstateEntry, 'this', _riesling_n1.new_Hv_HtstateEntry(*args))
...
_riesling_n1.Hv_HtstateEntry_swigregister(Hv_HtstateEntryPtr)
...
_riesling_n1.Hv_Htstate_swigregister(Hv_HtstatePtr)
...
_riesling_n1.Vis2_GsrReg_swigregister(Vis2_GsrRegPtr)
...
_riesling_n1.Hv_HpstateReg_swigregister(Hv_HpstateRegPtr)
...
_riesling_n1.Hv_HtbaReg_swigregister(Hv_HtbaRegPtr)
...
_riesling_n1.Ni_HverReg_swigregister(Ni_HverRegPtr)
...
_riesling_n1.Hv_HintpReg_swigregister(Hv_HintpRegPtr)
...
_riesling_n1.Hv_HstickCompareReg_swigregister(Hv_HstickCompareRegPtr)
...
_riesling_n1.Hv_GlobalLevelReg_swigregister(Hv_GlobalLevelRegPtr)
...
_riesling_n1.Hv_ScratchPad_swigregister(Hv_ScratchPadPtr)
...
_riesling_n1.Ni_ArchState_swigregister(Ni_ArchStatePtr)
...
_riesling_n1.Ni_Strand_swigregister(Ni_StrandPtr)
...
_riesling_n1.Ni_Core_swigregister(Ni_CorePtr)
...
_riesling_n1.Ni_Cpu_swigregister(Ni_CpuPtr)
...
class Ni_System(_object):
    ...
    def __init__(self, *args):
        _swig_setattr(self, Ni_System, 'this', _riesling_n1.new_Ni_System(*args))
...
_riesling_n1.Ni_System_swigregister(Ni_SystemPtr)
